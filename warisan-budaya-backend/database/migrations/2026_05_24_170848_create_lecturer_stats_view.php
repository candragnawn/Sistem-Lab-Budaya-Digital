...
return new class extends Migration {
    ...
    {
        DB::statement("CREATE VIEW v_lecturer_stats AS
            SELECT
                l.id as lecturer_id,
                ...
                (SELECT COUNT(*) FROM lecturer_hkis WHERE lecturer_id = l.id) as hki_count,
                ...
                (SELECT COUNT(*) FROM publications WHERE lecturer_id = l.id AND source = 'manual') as manual_count,
                (SELECT COUNT(*) FROM research WHERE lecturer_id = l.id) as research_count,
                (SELECT COUNT(*) FROM community_services WHERE lecturer_id = l.id) as community_service_count
            FROM lecturer l
        "); 
    }
