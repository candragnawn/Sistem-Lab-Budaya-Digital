...
export default function RiwayatPekerjaanPage() {
  ...
  const filteredData = riwayatPekerjaanData.filter(
    (item) =>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 text-sm">
        ...
        <ChevronRight className="h-3 w-3 text-gray-400" />
        <span className="text-[#1E3A5F] font-semibold">Riwayat Pekerjaan</span>
      </div>
      ...
      <div className="rounded-xl bg-white shadow-sm border border-gray-100 overflow-hidden">
        <div className="bg-gradient-to-r from-[#1E3A5F]/5 to-transparent p-6 border-b border-gray-100">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h2 className="text-2xl font-bold text-gray-900">Riwayat Pekerjaan</h2>
              <p className="mt-1.5 text-sm text-gray-500">
                Riwayat pekerjaan sebelum menjadi dosen tetap.
              </p>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1.5 rounded-full bg-green-50 border border-green-200 px-3 py-1.5">
                <CheckCircle className="h-3.5 w-3.5 text-green-600" />
                <span className="text-xs font-semibold text-green-700">Lengkap</span>
              </div>
        ...
        <div className="p-6">
          ...
          <div className="overflow-x-auto rounded-lg border border-gray-200">
            <table className="w-full text-sm" id="riwayat-pekerjaan-table">
              <thead>
          ...
          <div className="mt-4 flex items-center justify-between">
            <p className="text-xs text-gray-500">
              Menampilkan {filteredData.length} dari {riwayatPekerjaanData.length} data
            </p>
