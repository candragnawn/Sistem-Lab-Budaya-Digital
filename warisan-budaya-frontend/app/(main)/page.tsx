      ...
      <section className="w-full bg-brand-navy py-8 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div className="flex flex-col items-center justify-center space-y-2">
            <h2 className="text-4xl font-bold text-brand-gold">8</h2>
            <p className="text-white/90 text-sm font-light">Total Arsip</p>
          </div>
          <div className="flex flex-col items-center justify-center space-y-2">
            <h2 className="text-4xl font-bold text-brand-gold">2</h2>
