  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-base font-medium text-white">Data Bahan Ajar</h2>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-[#111827] h-[36px]">
                <th className="px-3.5 text-left text-[11px] font-medium text-gray-400">Judul</th>
                <th className="px-3.5 text-left text-[11px] font-medium text-gray-400">ISBN</th>
                <th className="px-3.5 text-left text-[11px] font-medium text-gray-400">Tanggal Publikasi</th>
                <th className="px-3.5 text-left text-[11px] font-medium text-gray-400">Penerbit</th>
            ...
            <tbody>
              {mockData.map((item, i) => (
                <tr key={item.id} className={`h-[44px] hover:bg-gray-800 ${i < mockData.length - 1 ? 'border-b border-gray-700' : ''}`}>
                  <td className="px-3.5 text-[11px] text-white max-w-[300px] truncate">{item.judul}</td>
                  <td className="px-3.5 text-[11px] text-white">{item.isbn}</td>
                  <td className="px-3.5 text-[11px] text-white">{item.tanggal_publikasi}</td>
                  <td className="px-3.5 text-[11px] text-white">{item.penerbit}</td>
                  <td className="px-3.5">
