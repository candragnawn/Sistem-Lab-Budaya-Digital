...
const mockData: OrasiIlmiahData[] = [
  {
    id: 1,
    kategori_kegiatan: 'Orasi Ilmiah Dies Natalis',
    judul_makalah: 'Transformasi Digital Warisan Lontar Bali: Tantangan dan Harapan',
    nama_dosen_tamu: 'Dr. Anak Agung Candra Gunawan',
    penyelenggara: 'Fakultas Teknik dan Kejuruan Undiksha',
    tanggal_kegiatan: '2024-01-10',
  },
];

export function OrasiIlmiah() {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-base font-medium text-brand-card">Data Orasi Ilmiah</h2>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-surface-darker h-[36px]">
                ...
                <th className="px-3.5 text-left text-[11px] font-medium text-text-placeholder">Nama Dosen</th>
