  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-base font-medium text-brand-card">Riwayat Pendidikan Formal</h2>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-surface-darker h-[36px]">
                <th className="px-3.5 text-left text-[11px] font-medium text-text-placeholder">Jenjang</th>
                <th className="px-3.5 text-left text-[11px] font-medium text-text-placeholder">Perguruan Tinggi</th>
                <th className="px-3.5 text-left text-[11px] font-medium text-text-placeholder">Fakultas</th>
                <th className="px-3.5 text-left text-[11px] font-medium text-text-placeholder">Program Studi</th>
                <th className="px-3.5 text-left text-[11px] font-medium text-text-placeholder">Tahun</th>
                <th className="px-3.5 text-left text-[11px] font-medium text-text-placeholder">Gelar</th>
            ...
            <tbody>
              {mockData.map((item, i) => (
                <tr key={item.id} className={`h-[44px] hover:bg-gray-800 ${i < mockData.length - 1 ? 'border-b border-border-dark' : ''}`}>
                  <td className="px-3.5 text-[11px] text-brand-card">{item.jenjang_pendidikan}</td>
                  <td className="px-3.5 text-[11px] text-brand-card">{item.nama_perguruan_tinggi}</td>
                  <td className="px-3.5 text-[11px] text-brand-card">{item.fakultas}</td>
                  <td className="px-3.5 text-[11px] text-brand-card">{item.program_studi}</td>
                  <td className="px-3.5 text-[11px] text-brand-card">{item.tahun_masuk} - {item.tahun_lulus}</td>
                  <td className="px-3.5 text-[11px] text-brand-card">{item.gelar_akademik}</td>
                  <td className="px-3.5">
