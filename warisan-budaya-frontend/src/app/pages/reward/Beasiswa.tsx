  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-base font-medium text-brand-card">Data Beasiswa</h2>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-surface-darker h-[36px]">
                <th className="px-3.5 text-left text-[11px] font-medium text-text-placeholder">Jenis Beasiswa</th>
                <th className="px-3.5 text-left text-[11px] font-medium text-text-placeholder">Nama Beasiswa</th>
                <th className="px-3.5 text-left text-[11px] font-medium text-text-placeholder">Tahun Mulai</th>
                <th className="px-3.5 text-left text-[11px] font-medium text-text-placeholder">Tahun Selesai</th>
            ...
            <tbody>
              {mockData.map((item, i) => (
                <tr key={item.id} className={`h-[44px] hover:bg-gray-800 ${i < mockData.length - 1 ? 'border-b border-border-dark' : ''}`}>
                  <td className="px-3.5 text-[11px] text-brand-card">{item.jenis_beasiswa}</td>
                  <td className="px-3.5 text-[11px] text-brand-card">{item.nama_beasiswa}</td>
                  <td className="px-3.5 text-[11px] text-brand-card">{item.tahun_mulai}</td>
                  <td className="px-3.5 text-[11px] text-brand-card">{item.tahun_selesai}</td>
                  <td className="px-3.5">
