  ...
  return (
    <div className="min-h-screen bg-page-dark">
      ...
      <nav className="bg-transparent absolute top-0 left-0 w-full z-30">
        ...
        <section 
        className="min-h-[600px] relative bg-cover bg-[center_top_20%] bg-no-repeat w-full flex flex-col justify-center"
      ...
      > 
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-page-dark/80 via-page-dark/90 to-page-dark pointer-events-none" />
        
        <div className="container relative z-10 mx-auto px-4 py-20">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-2xl text-brand-card mb-3 text-center font-medium">
            ...
            <div className="flex items-center justify-center gap-3">
              <Link
                to="/dosen"
                className="flex items-center gap-2 px-3 py-2 bg-info-landing text-brand-card rounded-[4px] text-xs hover:bg-info-hover transition-colors"
              >
                Lihat Daftar Dosen
      ...
      <div className="-mt-8 container relative z-20 mx-auto px-4 pb-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-4xl mx-auto">
          <div className="bg-surface-dark/95 backdrop-blur-sm border border-border-dark rounded-[4px] p-3 text-center shadow-lg">
            <div className="text-xl text-brand-card mb-1 font-medium">150+</div>
            <div className="text-[10px] text-text-placeholder">Dosen Aktif</div>
          </div>
          <div className="bg-surface-dark/95 backdrop-blur-sm border border-border-dark rounded-[4px] p-3 text-center shadow-lg">
            <div className="text-xl text-brand-card mb-1 font-medium">1,200+</div>
            <div className="text-[10px] text-text-placeholder">Publikasi</div>
          </div>
          <div className="bg-surface-dark/95 backdrop-blur-sm border border-border-dark rounded-[4px] p-3 text-center shadow-lg">
            <div className="text-xl text-brand-card mb-1 font-medium">500+</div>
            <div className="text-[10px] text-text-placeholder">Penelitian</div>
          </div>
          <div className="bg-surface-dark/95 backdrop-blur-sm border border-border-dark rounded-[4px] p-3 text-center shadow-lg">
            <div className="text-xl text-brand-card mb-1 font-medium">300+</div>
