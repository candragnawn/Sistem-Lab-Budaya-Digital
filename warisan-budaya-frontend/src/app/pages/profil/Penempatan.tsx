  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-base font-medium text-white">Riwayat Penempatan</h2>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-[#111827] h-[36px]">
                <th className="px-3.5 text-left text-[11px] font-medium text-gray-400">Status Ikatan Kerja</th>
                ...
                <th className="px-3.5 text-left text-[11px] font-medium text-gray-400">TMT Tugas</th>
                <th className="px-3.5 text-left text-[11px] font-medium text-gray-400">TST Tugas</th>
            ...
            <tbody>
              {mockData.map((item, i) => (
                <tr key={item.id} className={`h-[44px] hover:bg-gray-800 ${i < mockData.length - 1 ? 'border-b border-gray-700' : ''}`}>
                  <td className="px-3.5 text-[11px] text-white">{item.status_ikatan_kerja}</td>
                  ...
                  <td className="px-3.5 text-[11px] text-white">{item.tmt_tugas}</td>
                  <td className="px-3.5 text-[11px] text-white">{item.tst_tugas || '-'}</td>
                  <td className="px-3.5">
