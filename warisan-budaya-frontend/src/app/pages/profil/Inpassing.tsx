  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-base font-medium text-white">Data Inpassing</h2>
        {canWrite && (
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-[#111827] h-[36px]">
                <th className="px-3.5 text-left text-[11px] font-medium text-gray-400">Pangkat/Golongan</th>
                ...
                <th className="px-3.5 text-left text-[11px] font-medium text-gray-400">TMT Inpassing</th>
                <th className="px-3.5 text-left text-[11px] font-medium text-gray-400">Angka Kredit</th>
            ...
            <tbody>
              {mockData.map((item, i) => (
                <tr key={item.id} className={`h-[44px] hover:bg-gray-800 ${i < mockData.length - 1 ? 'border-b border-gray-700' : ''}`}>
                  <td className="px-3.5 text-[11px] text-white">{item.pangkat_golongan}</td>
                  <td className="px-3.5 text-[11px] text-white">{item.nomor_sk}</td>
                  <td className="px-3.5 text-[11px] text-white">{item.tanggal_sk}</td>
                  <td className="px-3.5 text-[11px] text-white">{item.tmt_inpassing}</td>
                  <td className="px-3.5 text-[11px] text-white">{item.angka_kredit}</td>
