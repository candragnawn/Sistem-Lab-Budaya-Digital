  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-base font-medium text-white">Data Paten/HKI</h2>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-[#111827] h-[36px]">
                <th className="px-3.5 text-left text-[11px] font-medium text-gray-400">Judul HKI</th>
                ...
                <th className="px-3.5 text-left text-[11px] font-medium text-gray-400">No. Pendaftaran</th>
                <th className="px-3.5 text-left text-[11px] font-medium text-gray-400">No. Paten/Sertifikat</th>
            ...
            <tbody>
              {mockData.map((item, i) => (
                <tr key={item.id} className={`h-[44px] hover:bg-gray-800 ${i < mockData.length - 1 ? 'border-b border-gray-700' : ''}`}>
                  <td className="px-3.5 text-[11px] text-white max-w-[250px] truncate">{item.judul_hki}</td>
                  <td className="px-3.5 text-[11px] text-white">{item.kategori_kegiatan}</td>
                  <td className="px-3.5 text-[11px] text-white">{item.jenis_hki}</td>
                  <td className="px-3.5 text-[11px] text-white">{item.nomor_pendaftaran}</td>
                  <td className="px-3.5 text-[11px] text-white">{item.nomor_paten_sertifikat}</td>
                  <td className="px-3.5">
