...
export default function Page() {
  return (
    <div className="flex flex-col min-h-screen bg-[#FDFBF7]">
      ...
      <div className="w-full bg-white px-6 py-3 border-b shadow-sm">
        <div className="max-w-7xl mx-auto">
          <p className="text-sm text-gray-600">
            <span className="font-semibold text-[#1E3A5F]">Universitas Udayana </span> / Laboratorium Warisan Budaya Digital
          </p>
        </div>
      </div>
      ...
      <section className="w-full bg-[#1E3A5F] py-8 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div className="flex flex-col items-center justify-center space-y-2">
            <h2 className="text-4xl font-bold text-[#C9A84C]">1.247</h2>
            <p className="text-white/90 text-sm font-light">Total Arsip Digital</p>
          </div>
          <div className="flex flex-col items-center justify-center space-y-2">
            <h2 className="text-4xl font-bold text-[#C9A84C]">67</h2>
          ...
          <div className="flex flex-col items-center justify-center space-y-2">
            <h2 className="text-4xl font-bold text-[#C9A84C]">69</h2>
      ...
      <section className="w-full py-16 px-6">
        <div className="max-w-6xl mx-auto text-center mb-10">
          <p className="text-[#C9A84C] font-bold text-xs tracking-[0.2em] uppercase mb-3">Kategori Koleksi</p>
          <h2 className="text-2xl md:text-3xl font-bold text-[#1E3A5F]">Jelajahi Berdasarkan Jenis Arsip</h2>
        </div>
            ...
            <CardContent className="p-8 flex flex-col items-center text-center space-y-4">
              <div className="text-5xl mb-2">
               <img src="book.png" alt="Icon Buku" className="w-12 h-12 object-contain" />
                  ...
                  <div>
                <h3 className="font-bold text-[#1E3A5F] text-lg">Bahan Ajar</h3>
            ...
            <CardContent className="p-8 flex flex-col items-center text-center space-y-4">
              <div className="text-5xl mb-2">
               <img src="hki.png" alt="Icon Buku" className="w-12 h-12 object-contain" />
                  ...
                  <div>
                <h3 className="font-bold text-[#1E3A5F] text-lg">HKI</h3>
